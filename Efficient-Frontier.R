##
#http://timelyportfolio.blogspot.com/2011/10/efficient-frontier-of-buy-hold-and.html
##
...
getSymbols("^GSPC",from="1980-01-01",to=Sys.Date())   #get monthly close
sp500 <- to.weekly(GSPC)[,4]
...
sp500.ret <- weeklyReturn(sp500)   

#get 10 month Mebane Faber moving average
ma <- runMean(sp500,n=10)

#if close > 10 month moving average then 1 and 0 if <
signal <- ifelse(sp500 > ma,1,0)   

#merge originial return data with this new data
...
colnames(returnComp) <- c("SP500","SP500.Faber")   
