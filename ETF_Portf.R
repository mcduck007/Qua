...
#portfolio outperforms the benchmark on an anuualized basis:
...
#generate return streams for all of the ETFs in the portfolio and then perform some operations
...
#relative performance vs. the benchmark portfolio
par(mfrow = c(1, 1))
...
#returns for each asset class in bar chart form with the 20 day Std Dev and the most recent 1 day VaR (95%) observation indicated by a solid line
par(mfrow = c(1, 1))
