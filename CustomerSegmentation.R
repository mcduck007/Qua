...
#copied from http://analyzecore.com/2015/02/19/customer-segmentation-lifecycle-grids-clv-and-cac-with-r/
...
#
#plot two charts: the first one representing the totals and the second one representing the averages:
#
